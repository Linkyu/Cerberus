...
namespace Calculator
{
    internal static class Program
    {
	    ...
	    private static void ProcessPacket(Packet packet, SocketContainer socketContainer)
	    {
		    ...
		    if (packet.Command != Commands.Identify) return;
		    var responsePacket = new Packet(Commands.IdentifyAck,null,"Calculator");
		    connector.Send(responsePacket, socketContainer);
